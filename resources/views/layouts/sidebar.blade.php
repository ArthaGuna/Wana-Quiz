...
<body class="font-sans antialiased">
    <div class="flex h-screen bg-gray-100">
        ...
        <div id="sidebar-overlay" class="fixed inset-0 bg-black bg-opacity-40 hidden z-30 transition-opacity duration-300 lg:hidden"></div>

        <!-- Sidebar Component -->
        <div id="sidebar" class="w-64 bg-white shadow-lg flex flex-col flex-shrink-0 transform translate-x-full lg:translate-x-0 transition-transform duration-300 ease-in-out fixed lg:relative inset-y-0 right-0 z-40">
            <!-- Header Sidebar -->
            ...
            <header class="bg-white shadow flex-shrink-0">
                <div class="flex items-center justify-between px-4 sm:px-6 py-4">
                    ...
                    <div class="flex items-center gap-3">
                        <button id="mobile-sidebar-toggle" class="lg:hidden text-gray-900 hover:text-purple-700 focus:outline-none">
                            <svg id="menu-open-icon" class="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h16" />
                            </svg>
                            <svg id="menu-close-icon" class="h-7 w-7 hidden" fill="none" viewBox="0 0 24 24" stroke="currentColor">
